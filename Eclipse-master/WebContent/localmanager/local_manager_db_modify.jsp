...
<%
  ...
  if(conn==null)
  {
	...
	String query = String.format("UPDATE local_manager set name := '%s', gender := '%s', address := '%s', e_mail := '%s', location := '%s' where l_no = %s;",name,gender,address,e_mail,location,idx);
